...
|---|---|
| `forked_react_compiler_hir` | `src/HIR/` (excluding `BuildHIR.ts`, `HIRBuilder.ts`) |
| `forked_react_compiler_lowering` | `src/HIR/BuildHIR.ts`, `src/HIR/HIRBuilder.ts` |
| `forked_react_compiler` | `src/Babel/`, `src/Entrypoint/` |
| `forked_react_compiler_diagnostics` | `src/CompilerError.ts` |
| `forked_react_compiler_<name>` | `src/<Name>/` (1:1, e.g., `forked_react_compiler_optimization` -> `src/Optimization/`) |
