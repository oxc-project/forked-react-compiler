...
walk_program_mut/walk_statement_mut/walk_expression_mut free functions to oxc_react_compiler_ast.
...
(environment.rs), and is_use_operator_type (lib.rs). Also created oxc_react_compiler_utils
...
Ported AnalyseFunctions pass (#11) from TypeScript. Created oxc_react_compiler_inference crate.
...
Ported DeadCodeElimination (#14) from TypeScript into oxc_react_compiler_optimization crate.
...
Created validate_no_derived_computations_in_effects.rs (1269 lines) in oxc_react_compiler_validation.
...
## 20260328-235900 Remove local visitor copies — use canonical oxc_react_compiler_hir::visitors

Replaced ~1,800 lines of duplicated visitor/iterator match logic across 21 files with
calls to canonical `oxc_react_compiler_hir::visitors` functions. Remaining local functions are
...
Created optimize_for_ssr.rs in oxc_react_compiler_optimization crate. Added is_plain_object_type
and is_start_transition_type helpers to oxc_react_compiler_hir.
...
Moved error formatting from JS to Rust: added code_frame.rs to oxc_react_compiler_diagnostics
