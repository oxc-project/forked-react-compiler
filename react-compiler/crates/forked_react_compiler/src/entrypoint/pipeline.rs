...
use forked_react_compiler_diagnostics::CompilerError;
use forked_react_compiler_hir::ReactFunctionType;
use forked_react_compiler_hir::environment::Environment;
use forked_react_compiler_hir::environment::OutputMode;
use forked_react_compiler_hir::environment_config::EnvironmentConfig;
use forked_react_compiler_lowering::FunctionNode;
...
pub fn compile_fn(
    ...
    let mut hir = forked_react_compiler_lowering::lower(func, fn_name, scope_info, &mut env)?;
    context.timing.stop();
    ...
    forked_react_compiler_optimization::prune_maybe_throws(&mut hir, &mut env.functions)?;
    context.timing.stop();
    ...
    forked_react_compiler_validation::validate_context_variable_lvalues(&hir, &mut env)?;
    if context.debug_enabled {
    ...
    let void_memo_errors = forked_react_compiler_validation::validate_use_memo(&hir, &mut env);
    ...
    forked_react_compiler_optimization::drop_manual_memoization(&mut hir, &mut env)?;
    context.timing.stop();
    ...
    forked_react_compiler_optimization::inline_immediately_invoked_function_expressions(
        &mut hir, &mut env,
    );
    context.timing.stop();
    ...
    forked_react_compiler_optimization::merge_consecutive_blocks::merge_consecutive_blocks(
        &mut hir,
        &mut env.functions,
    );
    context.timing.stop();
    ...
    forked_react_compiler_ssa::enter_ssa(&mut hir, &mut env).map_err(|diag| {
        let loc = diag.primary_location().cloned();
        let mut err = CompilerError::new();
        err.push_error_detail(forked_react_compiler_diagnostics::CompilerErrorDetail {
    ...
    forked_react_compiler_ssa::eliminate_redundant_phi(&mut hir, &mut env);
    context.timing.stop();
    ...
    forked_react_compiler_optimization::constant_propagation(&mut hir, &mut env);
    context.timing.stop();
    ...
    forked_react_compiler_typeinference::infer_types(&mut hir, &mut env)?;
    context.timing.stop();
    ...
    if env.enable_validations() {
        if env.config.validate_hooks_usage {
            ...
            forked_react_compiler_validation::validate_hooks_usage(&hir, &mut env)?;
            if context.debug_enabled {
        ...
        if env.config.validate_no_capitalized_calls.is_some() {
            ...
            forked_react_compiler_validation::validate_no_capitalized_calls(&hir, &mut env)?;
            if context.debug_enabled {
                context.log_debug(DebugLogEntry::new(
    ...
    forked_react_compiler_optimization::optimize_props_method_calls(&mut hir, &env);
    context.timing.stop();
    ...
    let analyse_result = forked_react_compiler_inference::analyse_functions(
        &mut hir,
        &mut env,
    ...
    forked_react_compiler_inference::infer_mutation_aliasing_effects(&mut hir, &mut env, false)?;
    context.timing.stop();
    ...
    if env.output_mode == OutputMode::Ssr {
        ...
        forked_react_compiler_optimization::optimize_for_ssr(&mut hir, &env);
        context.timing.stop();
    ...
    forked_react_compiler_optimization::dead_code_elimination(&mut hir, &env);
    context.timing.stop();
    ...
    forked_react_compiler_inference::infer_mutation_aliasing_ranges(&mut hir, &mut env, false)?;
    context.timing.stop();
    ...
    if env.enable_validations() {
        ...
        forked_react_compiler_validation::validate_locals_not_reassigned_after_render(&hir, &mut env);
        if context.debug_enabled {
            context.log_debug(DebugLogEntry::new(
        ...
        if env.config.validate_ref_access_during_render {
            ...
            forked_react_compiler_validation::validate_no_ref_access_in_render(&hir, &mut env);
            if context.debug_enabled {
                context.log_debug(DebugLogEntry::new(
        ...
        if env.config.validate_no_set_state_in_render {
            ...
            forked_react_compiler_validation::validate_no_set_state_in_render(&hir, &mut env)?;
            if context.debug_enabled {
                context.log_debug(DebugLogEntry::new(
            ...
            && env.output_mode == OutputMode::Lint
        {
            ...
            let errors =
                forked_react_compiler_validation::validate_no_derived_computations_in_effects_exp(
                    &hir, &env,
                )?;
            ...
            context
                .timing
                .start("ValidateNoDerivedComputationsInEffects");
            forked_react_compiler_validation::validate_no_derived_computations_in_effects(&hir, &mut env)?;
            if context.debug_enabled {
                context.log_debug(DebugLogEntry::new(
                    "ValidateNoDerivedComputationsInEffects",
                    "ok".to_string(),
        ...
        if env.config.validate_no_set_state_in_effects && env.output_mode == OutputMode::Lint {
            ...
            let errors = forked_react_compiler_validation::validate_no_set_state_in_effects(&hir, &env)?;
            log_errors_as_events(&errors, context);
            if context.debug_enabled {
                context.log_debug(DebugLogEntry::new(
        ...
        if env.config.validate_no_jsx_in_try_statements && env.output_mode == OutputMode::Lint {
            ...
            let errors = forked_react_compiler_validation::validate_no_jsx_in_try_statement(&hir);
            log_errors_as_events(&errors, context);
            if context.debug_enabled {
                context.log_debug(DebugLogEntry::new(
        ...
        forked_react_compiler_validation::validate_no_freezing_known_mutable_functions(&hir, &mut env);
        if context.debug_enabled {
            context.log_debug(DebugLogEntry::new(
    ...
    forked_react_compiler_inference::infer_reactive_places(&mut hir, &mut env)?;
    context.timing.stop();
    ...
    if env.enable_validations() {
        ...
        forked_react_compiler_validation::validate_exhaustive_dependencies(&mut hir, &mut env)?;
        if context.debug_enabled {
            context.log_debug(DebugLogEntry::new(
    ...
    forked_react_compiler_ssa::rewrite_instruction_kinds_based_on_reassignment(&mut hir, &env)?;
    context.timing.stop();
        ...
        && env.output_mode == OutputMode::Lint
    {
        ...
        let errors = forked_react_compiler_validation::validate_static_components(&hir);
        log_errors_as_events(&errors, context);
        if context.debug_enabled {
            context.log_debug(DebugLogEntry::new(
    ...
    if env.enable_memoization() {
        ...
        forked_react_compiler_inference::infer_reactive_scope_variables(&mut hir, &mut env)?;
        context.timing.stop();
    ...
    let fbt_operands =
        forked_react_compiler_inference::memoize_fbt_and_macro_operands_in_same_scope(&hir, &mut env);
    context.timing.stop();
    ...
    if env.config.enable_jsx_outlining {
        ...
        forked_react_compiler_optimization::outline_jsx(&mut hir, &mut env);
        context.timing.stop();
    }

    if env.config.enable_name_anonymous_functions {
        context.timing.start("NameAnonymousFunctions");
        forked_react_compiler_optimization::name_anonymous_functions(&mut hir, &mut env);
        context.timing.stop();
    ...
    if env.config.enable_function_outlining {
        ...
        forked_react_compiler_optimization::outline_functions(&mut hir, &mut env, &fbt_operands);
        context.timing.stop();
    ...
    forked_react_compiler_inference::align_method_call_scopes(&mut hir, &mut env);
    context.timing.stop();
    ...
    forked_react_compiler_inference::align_object_method_scopes(&mut hir, &mut env);
    context.timing.stop();
    ...
    forked_react_compiler_optimization::prune_unused_labels_hir(&mut hir);
    context.timing.stop();
    ...
    forked_react_compiler_inference::align_reactive_scopes_to_block_scopes_hir(&mut hir, &mut env);
    context.timing.stop();
    ...
    forked_react_compiler_inference::merge_overlapping_reactive_scopes_hir(&mut hir, &mut env);
    context.timing.stop();
    ...
    forked_react_compiler_inference::build_reactive_scope_terminals_hir(&mut hir, &mut env);
    context.timing.stop();
    ...
    forked_react_compiler_inference::flatten_reactive_loops_hir(&mut hir);
    context.timing.stop();
    ...
    forked_react_compiler_inference::flatten_scopes_with_hooks_or_use_hir(&mut hir, &env)?;
    context.timing.stop();
    ...
    forked_react_compiler_inference::propagate_scope_dependencies_hir(&mut hir, &mut env);
    context.timing.stop();
    ...
    let hir_formatter = |fmt: &mut forked_react_compiler_hir::print::PrintFormatter,
                         func: &forked_react_compiler_hir::HirFunction| {
        debug_print::format_hir_function_into(fmt, func);
    };

    if context.debug_enabled {
        context.timing.start("debug_print:BuildReactiveFunction");
        let debug_reactive = forked_react_compiler_reactive_scopes::print_reactive_function::debug_reactive_function_with_formatter(
    ...
    forked_react_compiler_reactive_scopes::assert_well_formed_break_targets(&reactive_fn, &env);
    if context.debug_enabled {
        context.log_debug(DebugLogEntry::new(
    ...
    forked_react_compiler_reactive_scopes::prune_unused_labels(&mut reactive_fn, &env)?;
    context.timing.stop();

    if context.debug_enabled {
        context.timing.start("debug_print:PruneUnusedLabels");
        let debug_prune_labels_reactive = forked_react_compiler_reactive_scopes::print_reactive_function::debug_reactive_function_with_formatter(
            &reactive_fn, &env, Some(&hir_formatter),
        );
        context.log_debug(DebugLogEntry::new(
            "PruneUnusedLabels",
    ...
    forked_react_compiler_reactive_scopes::assert_scope_instructions_within_scopes(&reactive_fn, &env)?;
    if context.debug_enabled {
        context.log_debug(DebugLogEntry::new(
    ...
    forked_react_compiler_reactive_scopes::prune_non_escaping_scopes(&mut reactive_fn, &mut env)?;
    context.timing.stop();

    if context.debug_enabled {
        context.timing.start("debug_print:PruneNonEscapingScopes");
        let debug = forked_react_compiler_reactive_scopes::print_reactive_function::debug_reactive_function_with_formatter(
            &reactive_fn, &env, Some(&hir_formatter),
        );
    ...
    forked_react_compiler_reactive_scopes::prune_non_reactive_dependencies(&mut reactive_fn, &mut env);
    context.timing.stop();
    ...
    if context.debug_enabled {
        ...
        let debug_prune_non_reactive = forked_react_compiler_reactive_scopes::print_reactive_function::debug_reactive_function_with_formatter(
            &reactive_fn, &env, Some(&hir_formatter),
        );
        context.log_debug(DebugLogEntry::new(
    ...
    forked_react_compiler_reactive_scopes::prune_unused_scopes(&mut reactive_fn, &env)?;
    context.timing.stop();

    if context.debug_enabled {
        context.timing.start("debug_print:PruneUnusedScopes");
        let debug_prune_unused_scopes = forked_react_compiler_reactive_scopes::print_reactive_function::debug_reactive_function_with_formatter(
            &reactive_fn, &env, Some(&hir_formatter),
        );
        context.log_debug(DebugLogEntry::new(
            "PruneUnusedScopes",
    ...
    forked_react_compiler_reactive_scopes::merge_reactive_scopes_that_invalidate_together(
        &mut reactive_fn,
        &mut env,
    )?;
    context.timing.stop();
    ...
    forked_react_compiler_reactive_scopes::prune_always_invalidating_scopes(&mut reactive_fn, &env)?;
    context.timing.stop();
    ...
    if context.debug_enabled {
        ...
        let debug_prune_always_inv = forked_react_compiler_reactive_scopes::print_reactive_function::debug_reactive_function_with_formatter(
            &reactive_fn, &env, Some(&hir_formatter),
        );
        context.log_debug(DebugLogEntry::new(
    ...
    forked_react_compiler_reactive_scopes::propagate_early_returns(&mut reactive_fn, &mut env);
    context.timing.stop();
    ...
    forked_react_compiler_reactive_scopes::prune_unused_lvalues(&mut reactive_fn, &env);
    context.timing.stop();

    if context.debug_enabled {
        context.timing.start("debug_print:PruneUnusedLValues");
        let debug_prune_lvalues = forked_react_compiler_reactive_scopes::print_reactive_function::debug_reactive_function_with_formatter(
            &reactive_fn, &env, Some(&hir_formatter),
        );
        context.log_debug(DebugLogEntry::new(
            "PruneUnusedLValues",
    ...
    forked_react_compiler_reactive_scopes::promote_used_temporaries(&mut reactive_fn, &mut env);
    context.timing.stop();
    ...
    forked_react_compiler_reactive_scopes::extract_scope_declarations_from_destructuring(
        &mut reactive_fn,
        &mut env,
    )?;
    context.timing.stop();
    ...
    forked_react_compiler_reactive_scopes::stabilize_block_ids(&mut reactive_fn, &mut env);
    context.timing.stop();

    if context.debug_enabled {
        context.timing.start("debug_print:StabilizeBlockIds");
        let debug_stabilize = forked_react_compiler_reactive_scopes::print_reactive_function::debug_reactive_function_with_formatter(
            &reactive_fn, &env, Some(&hir_formatter),
        );
    ...
    let unique_identifiers =
        forked_react_compiler_reactive_scopes::rename_variables(&mut reactive_fn, &mut env);
    context.timing.stop();
    ...
    forked_react_compiler_reactive_scopes::prune_hoisted_contexts(&mut reactive_fn, &mut env)?;
    context.timing.stop();
        ...
        || env.config.validate_preserve_existing_memoization_guarantees
    {
        ...
        forked_react_compiler_validation::validate_preserved_manual_memoization(&reactive_fn, &mut env);
        if context.debug_enabled {
            context.log_debug(DebugLogEntry::new(
    ...
    let codegen_result = forked_react_compiler_reactive_scopes::codegen_function(
        &reactive_fn,
        &mut env,
        unique_identifiers,
        fbt_operands,
    ...
    if env.config.throw_unknown_exception_testonly {
        let mut err = CompilerError::new();
        err.push_error_detail(forked_react_compiler_diagnostics::CompilerErrorDetail {
            category: forked_react_compiler_diagnostics::ErrorCategory::Invariant,
...
pub fn compile_outlined_fn(
    ...
    let mut outlined_decl = forked_react_compiler_ast::statements::FunctionDeclaration {
        base: forked_react_compiler_ast::common::BaseNode::typed("FunctionDeclaration"),
        id: codegen_fn.id.take(),
        params: std::mem::take(&mut codegen_fn.params),
        body: std::mem::replace(
            &mut codegen_fn.body,
            forked_react_compiler_ast::statements::BlockStatement {
                base: forked_react_compiler_ast::common::BaseNode::typed("BlockStatement"),
                body: Vec::new(),
                directives: Vec::new(),
            },
        ),
    ...
    let func_node = forked_react_compiler_lowering::FunctionNode::FunctionDeclaration(&outlined_decl);
    let mut hir = forked_react_compiler_lowering::lower(&func_node, fn_name, &scope_info, &mut env)?;
...
fn build_outlined_scope_info(
    func: &mut forked_react_compiler_ast::statements::FunctionDeclaration,
) -> forked_react_compiler_ast::scope::ScopeInfo {
    use std::collections::HashMap;

    use forked_react_compiler_ast::scope::*;
...
fn outlined_assign_pattern_positions(
    pattern: &mut forked_react_compiler_ast::patterns::PatternLike,
    pos: &mut u32,
    kind: forked_react_compiler_ast::scope::BindingKind,
    fn_bindings: &mut std::collections::HashMap<String, forked_react_compiler_ast::scope::BindingId>,
    bindings_list: &mut Vec<forked_react_compiler_ast::scope::BindingData>,
    ref_to_binding: &mut indexmap::IndexMap<u32, forked_react_compiler_ast::scope::BindingId>,
) {
    use forked_react_compiler_ast::patterns::PatternLike;
    use forked_react_compiler_ast::scope::*;
    ...
    match pattern {
        ...
        PatternLike::ObjectPattern(obj) => {
            for prop in &mut obj.properties {
                match prop {
                    forked_react_compiler_ast::patterns::ObjectPatternProperty::ObjectProperty(
                        p_inner,
                    ) => {
                        outlined_assign_pattern_positions(
                            &mut p_inner.value,
                    ...
                    forked_react_compiler_ast::patterns::ObjectPatternProperty::RestElement(r) => {
                        outlined_assign_pattern_positions(
                            &mut r.argument,
                            pos,
                            kind.clone(),
...
fn outlined_assign_stmt_positions(
    stmt: &mut forked_react_compiler_ast::statements::Statement,
    pos: &mut u32,
    fn_bindings: &mut std::collections::HashMap<String, forked_react_compiler_ast::scope::BindingId>,
    bindings_list: &mut Vec<forked_react_compiler_ast::scope::BindingData>,
    ref_to_binding: &mut indexmap::IndexMap<u32, forked_react_compiler_ast::scope::BindingId>,
) {
    use forked_react_compiler_ast::statements::Statement;
        ...
        Statement::VariableDeclaration(decl) => {
            for declarator in &mut decl.declarations {
                ...
                outlined_assign_pattern_positions(
                    &mut declarator.id,
                    pos,
                    forked_react_compiler_ast::scope::BindingKind::Let,
                    fn_bindings,
                    bindings_list,
                    ref_to_binding,
                );
...
fn outlined_assign_expr_positions(
    expr: &mut forked_react_compiler_ast::expressions::Expression,
    pos: &mut u32,
    fn_bindings: &std::collections::HashMap<String, forked_react_compiler_ast::scope::BindingId>,
    ref_to_binding: &mut indexmap::IndexMap<u32, forked_react_compiler_ast::scope::BindingId>,
) {
    use forked_react_compiler_ast::expressions::*;
    ...
    match expr {
        ...
        Expression::JSXElement(jsx) => {
            ...
            for attr in &mut jsx.opening_element.attributes {
                match attr {
                    forked_react_compiler_ast::jsx::JSXAttributeItem::JSXAttribute(a) => {
                    ...
                    forked_react_compiler_ast::jsx::JSXAttributeItem::JSXSpreadAttribute(s) => {
                        outlined_assign_expr_positions(
                            &mut s.argument,
                            pos,
                            fn_bindings,
...
fn outlined_assign_jsx_name_positions(
    name: &mut forked_react_compiler_ast::jsx::JSXElementName,
    pos: &mut u32,
    fn_bindings: &std::collections::HashMap<String, forked_react_compiler_ast::scope::BindingId>,
    ref_to_binding: &mut indexmap::IndexMap<u32, forked_react_compiler_ast::scope::BindingId>,
) {
    match name {
        forked_react_compiler_ast::jsx::JSXElementName::JSXIdentifier(id) => {
            let p = *pos;
            *pos += 1;
            id.base.start = Some(p);
            if let Some(&bid) = fn_bindings.get(&id.name) {
        ...
        forked_react_compiler_ast::jsx::JSXElementName::JSXMemberExpression(m) => {
...
fn outlined_assign_jsx_member_positions(
    member: &mut forked_react_compiler_ast::jsx::JSXMemberExpression,
    pos: &mut u32,
    fn_bindings: &std::collections::HashMap<String, forked_react_compiler_ast::scope::BindingId>,
    ref_to_binding: &mut indexmap::IndexMap<u32, forked_react_compiler_ast::scope::BindingId>,
) {
    match &mut *member.object {
        forked_react_compiler_ast::jsx::JSXMemberExprObject::JSXIdentifier(id) => {
            let p = *pos;
            *pos += 1;
            id.base.start = Some(p);
            if let Some(&bid) = fn_bindings.get(&id.name) {
        ...
        forked_react_compiler_ast::jsx::JSXMemberExprObject::JSXMemberExpression(inner) => {
...
fn outlined_assign_jsx_val_positions(
    val: &mut forked_react_compiler_ast::jsx::JSXAttributeValue,
    pos: &mut u32,
    fn_bindings: &std::collections::HashMap<String, forked_react_compiler_ast::scope::BindingId>,
    ref_to_binding: &mut indexmap::IndexMap<u32, forked_react_compiler_ast::scope::BindingId>,
) {
    match val {
        forked_react_compiler_ast::jsx::JSXAttributeValue::JSXExpressionContainer(c) => {
            if let forked_react_compiler_ast::jsx::JSXExpressionContainerExpr::Expression(e) =
                &mut c.expression
            {
                outlined_assign_expr_positions(e, pos, fn_bindings, ref_to_binding);
            }
        }
        forked_react_compiler_ast::jsx::JSXAttributeValue::JSXElement(el) => {
            let mut expr = forked_react_compiler_ast::expressions::Expression::JSXElement(el.clone());
            outlined_assign_expr_positions(&mut expr, pos, fn_bindings, ref_to_binding);
            if let forked_react_compiler_ast::expressions::Expression::JSXElement(new_el) = expr {
                **el = *new_el;
            }
        }
        _ => {}
...
fn outlined_assign_jsx_child_positions(
    child: &mut forked_react_compiler_ast::jsx::JSXChild,
    pos: &mut u32,
    fn_bindings: &std::collections::HashMap<String, forked_react_compiler_ast::scope::BindingId>,
    ref_to_binding: &mut indexmap::IndexMap<u32, forked_react_compiler_ast::scope::BindingId>,
) {
    match child {
        forked_react_compiler_ast::jsx::JSXChild::JSXExpressionContainer(c) => {
            if let forked_react_compiler_ast::jsx::JSXExpressionContainerExpr::Expression(e) =
                &mut c.expression
            {
                outlined_assign_expr_positions(e, pos, fn_bindings, ref_to_binding);
        ...
        forked_react_compiler_ast::jsx::JSXChild::JSXElement(el) => {
            let mut expr =
                forked_react_compiler_ast::expressions::Expression::JSXElement(Box::new(*el.clone()));
            outlined_assign_expr_positions(&mut expr, pos, fn_bindings, ref_to_binding);
            if let forked_react_compiler_ast::expressions::Expression::JSXElement(new_el) = expr {
                **el = *new_el;
            }
        }
        forked_react_compiler_ast::jsx::JSXChild::JSXFragment(frag) => {
...
fn run_pipeline_passes(
    hir: &mut forked_react_compiler_hir::HirFunction,
    env: &mut Environment,
    context: &mut ProgramContext,
) -> Result<CodegenFunction, CompilerError> {
    forked_react_compiler_optimization::prune_maybe_throws(hir, &mut env.functions)?;

    forked_react_compiler_optimization::drop_manual_memoization(hir, env)?;

    forked_react_compiler_optimization::inline_immediately_invoked_function_expressions(hir, env);
    ...
    forked_react_compiler_ssa::enter_ssa(hir, env).map_err(|diag| {
        let loc = diag.primary_location().cloned();
        let mut err = CompilerError::new();
        err.push_error_detail(forked_react_compiler_diagnostics::CompilerErrorDetail {
            category: diag.category,
    ...
    forked_react_compiler_ssa::eliminate_redundant_phi(hir, env);

    forked_react_compiler_optimization::constant_propagation(hir, env);

    forked_react_compiler_typeinference::infer_types(hir, env)?;

    if env.enable_validations() {
        if env.config.validate_hooks_usage {
            forked_react_compiler_validation::validate_hooks_usage(hir, env)?;
        }
    }

    forked_react_compiler_optimization::optimize_props_method_calls(hir, env);

    forked_react_compiler_inference::analyse_functions(hir, env, &mut |_inner_func, _inner_env| {})?;

    if env.has_invariant_errors() {
        return Err(env.take_invariant_errors());
    }

    forked_react_compiler_inference::infer_mutation_aliasing_effects(hir, env, false)?;

    if env.output_mode == OutputMode::Ssr {
        forked_react_compiler_optimization::optimize_for_ssr(hir, env);
    }

    forked_react_compiler_optimization::dead_code_elimination(hir, env);

    forked_react_compiler_optimization::prune_maybe_throws(hir, &mut env.functions)?;

    forked_react_compiler_inference::infer_mutation_aliasing_ranges(hir, env, false)?;

    if env.enable_validations() {
        forked_react_compiler_validation::validate_locals_not_reassigned_after_render(hir, env);

        if env.config.validate_ref_access_during_render {
            forked_react_compiler_validation::validate_no_ref_access_in_render(hir, env);
        }

        if env.config.validate_no_set_state_in_render {
            forked_react_compiler_validation::validate_no_set_state_in_render(hir, env)?;
        }

        forked_react_compiler_validation::validate_no_freezing_known_mutable_functions(hir, env);
    }

    forked_react_compiler_inference::infer_reactive_places(hir, env)?;

    if env.enable_validations() {
        forked_react_compiler_validation::validate_exhaustive_dependencies(hir, env)?;
    }

    forked_react_compiler_ssa::rewrite_instruction_kinds_based_on_reassignment(hir, env)?;

    if env.enable_memoization() {
        forked_react_compiler_inference::infer_reactive_scope_variables(hir, env)?;
    }

    let fbt_operands =
        forked_react_compiler_inference::memoize_fbt_and_macro_operands_in_same_scope(hir, env);

    // Don't run outline_jsx on outlined functions (they're already outlined)

    if env.config.enable_name_anonymous_functions {
        forked_react_compiler_optimization::name_anonymous_functions(hir, env);
    }

    if env.config.enable_function_outlining {
        forked_react_compiler_optimization::outline_functions(hir, env, &fbt_operands);
    }

    forked_react_compiler_inference::align_method_call_scopes(hir, env);
    forked_react_compiler_inference::align_object_method_scopes(hir, env);

    forked_react_compiler_optimization::prune_unused_labels_hir(hir);

    forked_react_compiler_inference::align_reactive_scopes_to_block_scopes_hir(hir, env);
    forked_react_compiler_inference::merge_overlapping_reactive_scopes_hir(hir, env);

    forked_react_compiler_inference::build_reactive_scope_terminals_hir(hir, env);
    forked_react_compiler_inference::flatten_reactive_loops_hir(hir);
    forked_react_compiler_inference::flatten_scopes_with_hooks_or_use_hir(hir, env)?;
    forked_react_compiler_inference::propagate_scope_dependencies_hir(hir, env);
    let mut reactive_fn = forked_react_compiler_reactive_scopes::build_reactive_function(hir, env)?;
    ...
    forked_react_compiler_reactive_scopes::prune_non_escaping_scopes(&mut reactive_fn, env)?;
    forked_react_compiler_reactive_scopes::prune_non_reactive_dependencies(&mut reactive_fn, env);
    forked_react_compiler_reactive_scopes::prune_unused_scopes(&mut reactive_fn, env)?;
    forked_react_compiler_reactive_scopes::merge_reactive_scopes_that_invalidate_together(
        &mut reactive_fn,
        env,
    ...
    forked_react_compiler_reactive_scopes::prune_always_invalidating_scopes(&mut reactive_fn, env)?;
    forked_react_compiler_reactive_scopes::propagate_early_returns(&mut reactive_fn, env);
    forked_react_compiler_reactive_scopes::prune_unused_lvalues(&mut reactive_fn, env);
    forked_react_compiler_reactive_scopes::promote_used_temporaries(&mut reactive_fn, env);
    forked_react_compiler_reactive_scopes::extract_scope_declarations_from_destructuring(
        &mut reactive_fn,
        env,
    )?;
    forked_react_compiler_reactive_scopes::stabilize_block_ids(&mut reactive_fn, env);

    let unique_identifiers =
        forked_react_compiler_reactive_scopes::rename_variables(&mut reactive_fn, env);
    for name in &unique_identifiers {
        context.add_new_reference(name.clone());
    }

    forked_react_compiler_reactive_scopes::prune_hoisted_contexts(&mut reactive_fn, env)?;

    if env.config.enable_preserve_existing_memoization_guarantees
        || env.config.validate_preserve_existing_memoization_guarantees
    {
        forked_react_compiler_validation::validate_preserved_manual_memoization(&reactive_fn, env);
    }
...
fn log_errors_as_events(errors: &CompilerError, context: &mut ProgramContext) {
    ...
    for detail in &errors.details {
        let detail_info = match detail {
            forked_react_compiler_diagnostics::CompilerErrorOrDiagnostic::Diagnostic(d) => {
                let items: Option<Vec<CompilerErrorItemInfo>> = {
                    let v: Vec<CompilerErrorItemInfo> = d
                        .details
                        .iter()
                        .map(|item| match item {
                            forked_react_compiler_diagnostics::CompilerDiagnosticDetail::Error {
                                loc,
                                message,
                                identifier_name,
                            ...
                            forked_react_compiler_diagnostics::CompilerDiagnosticDetail::Hint {
                                message,
                            } => CompilerErrorItemInfo {
                                kind: "hint".to_string(),
                                loc: None,
            ...
            forked_react_compiler_diagnostics::CompilerErrorOrDiagnostic::ErrorDetail(d) => {
                CompilerErrorDetailInfo {
                    category: format!("{:?}", d.category),
                    reason: d.reason.clone(),
                    description: d.description.clone(),
