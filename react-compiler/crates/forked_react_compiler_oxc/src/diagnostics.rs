...
use forked_react_compiler::entrypoint::compile_result::{
...
fn error_info_to_diagnostic(error: &forked_react_compiler::entrypoint::compile_result::CompilerErrorInfo) -> OxcDiagnostic {
