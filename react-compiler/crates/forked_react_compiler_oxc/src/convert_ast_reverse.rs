...
//! Reverse AST converter: forked_react_compiler_ast (Babel format) → OXC AST.
//!
...
use forked_react_compiler_ast::declarations::*;
use forked_react_compiler_ast::expressions::*;
use forked_react_compiler_ast::jsx::*;
...
/// Convert a `forked_react_compiler_ast::File` into an OXC `Program` allocated in the given arena.
...
impl<'a> ReverseCtx<'a> {
    ...
    fn convert_program(&self, program: &forked_react_compiler_ast::Program) -> oxc::Program<'a> {
        let source_type = match program.source_type {
            forked_react_compiler_ast::SourceType::Module => oxc_span::SourceType::mjs(),
            forked_react_compiler_ast::SourceType::Script => oxc_span::SourceType::cjs(),
        };
    ...
    fn convert_template_literal(
        &self,
        tl: &forked_react_compiler_ast::expressions::TemplateLiteral,
    ...
    fn convert_class_to_oxc(
        &self,
        c: &forked_react_compiler_ast::expressions::ClassExpression,
