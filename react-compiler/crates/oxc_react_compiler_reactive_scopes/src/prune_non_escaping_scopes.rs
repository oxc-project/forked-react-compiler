...
use oxc_react_compiler_hir::ArrayPatternElement;
...
use oxc_react_compiler_hir::ReactiveInstruction;
use oxc_react_compiler_hir::ReactiveScopeBlock;
use oxc_react_compiler_hir::ReactiveStatement;
use oxc_react_compiler_hir::ReactiveTerminal;
use oxc_react_compiler_hir::ReactiveTerminalStatement;
...
use oxc_react_compiler_hir::visitors::each_instruction_value_operand;
...
pub fn prune_non_escaping_scopes(
    ...
    env: &mut Environment,
) -> Result<(), oxc_react_compiler_diagnostics::CompilerError> {
    ...
    for param in &func.params {
        let place = match param {
            oxc_react_compiler_hir::ParamPattern::Place(p) => p,
            oxc_react_compiler_hir::ParamPattern::Spread(s) => &s.place,
        };
...
impl<'a> ReactiveFunctionTransform for PruneScopesTransform<'a> {
    ...
    ) -> Result<Transformed<ReactiveStatement>, oxc_react_compiler_diagnostics::CompilerError> {
