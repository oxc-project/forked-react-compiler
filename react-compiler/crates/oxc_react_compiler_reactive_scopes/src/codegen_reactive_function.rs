...
use oxc_react_compiler_ast::common::BaseNode;
use oxc_react_compiler_ast::common::Position as AstPosition;
use oxc_react_compiler_ast::common::SourceLocation as AstSourceLocation;
use oxc_react_compiler_ast::expressions::ArrowFunctionBody;
use oxc_react_compiler_ast::expressions::Expression;
use oxc_react_compiler_ast::expressions::Identifier as AstIdentifier;
use oxc_react_compiler_ast::expressions::{self as ast_expr};
use oxc_react_compiler_ast::jsx::JSXAttribute as AstJSXAttribute;
...
use oxc_react_compiler_ast::jsx::JSXClosingElement;
use oxc_react_compiler_ast::jsx::JSXClosingFragment;
use oxc_react_compiler_ast::jsx::JSXElement;
use oxc_react_compiler_ast::jsx::JSXElementName;
use oxc_react_compiler_ast::jsx::JSXExpressionContainer;
use oxc_react_compiler_ast::jsx::JSXExpressionContainerExpr;
use oxc_react_compiler_ast::jsx::JSXFragment;
use oxc_react_compiler_ast::jsx::JSXIdentifier;
use oxc_react_compiler_ast::jsx::JSXMemberExprObject;
use oxc_react_compiler_ast::jsx::JSXMemberExpression;
use oxc_react_compiler_ast::jsx::JSXNamespacedName;
use oxc_react_compiler_ast::jsx::JSXOpeningElement;
use oxc_react_compiler_ast::jsx::JSXOpeningFragment;
use oxc_react_compiler_ast::jsx::JSXSpreadAttribute;
use oxc_react_compiler_ast::jsx::JSXText;
use oxc_react_compiler_ast::literals::BooleanLiteral;
use oxc_react_compiler_ast::literals::NullLiteral;
use oxc_react_compiler_ast::literals::NumericLiteral;
use oxc_react_compiler_ast::literals::RegExpLiteral as AstRegExpLiteral;
use oxc_react_compiler_ast::literals::StringLiteral;
use oxc_react_compiler_ast::literals::TemplateElement;
use oxc_react_compiler_ast::literals::TemplateElementValue;
use oxc_react_compiler_ast::operators::AssignmentOperator;
use oxc_react_compiler_ast::operators::BinaryOperator as AstBinaryOperator;
use oxc_react_compiler_ast::operators::LogicalOperator as AstLogicalOperator;
use oxc_react_compiler_ast::operators::UnaryOperator as AstUnaryOperator;
use oxc_react_compiler_ast::operators::UpdateOperator as AstUpdateOperator;
use oxc_react_compiler_ast::patterns::ArrayPattern as AstArrayPattern;
use oxc_react_compiler_ast::patterns::ObjectPatternProp;
use oxc_react_compiler_ast::patterns::ObjectPatternProperty;
use oxc_react_compiler_ast::patterns::PatternLike;
use oxc_react_compiler_ast::patterns::RestElement;
use oxc_react_compiler_ast::statements::BlockStatement;
use oxc_react_compiler_ast::statements::BreakStatement;
use oxc_react_compiler_ast::statements::CatchClause;
use oxc_react_compiler_ast::statements::ContinueStatement;
use oxc_react_compiler_ast::statements::DebuggerStatement;
use oxc_react_compiler_ast::statements::Directive;
use oxc_react_compiler_ast::statements::DirectiveLiteral;
use oxc_react_compiler_ast::statements::DoWhileStatement;
use oxc_react_compiler_ast::statements::EmptyStatement;
use oxc_react_compiler_ast::statements::ExpressionStatement;
use oxc_react_compiler_ast::statements::ForInStatement;
use oxc_react_compiler_ast::statements::ForInit;
use oxc_react_compiler_ast::statements::ForOfStatement;
use oxc_react_compiler_ast::statements::ForStatement;
use oxc_react_compiler_ast::statements::FunctionDeclaration;
use oxc_react_compiler_ast::statements::IfStatement;
use oxc_react_compiler_ast::statements::LabeledStatement;
use oxc_react_compiler_ast::statements::ReturnStatement;
use oxc_react_compiler_ast::statements::Statement;
use oxc_react_compiler_ast::statements::SwitchCase;
use oxc_react_compiler_ast::statements::SwitchStatement;
use oxc_react_compiler_ast::statements::ThrowStatement;
use oxc_react_compiler_ast::statements::TryStatement;
use oxc_react_compiler_ast::statements::VariableDeclaration;
use oxc_react_compiler_ast::statements::VariableDeclarationKind;
use oxc_react_compiler_ast::statements::VariableDeclarator;
use oxc_react_compiler_ast::statements::WhileStatement;
...
use oxc_react_compiler_diagnostics::SourceLocation as DiagSourceLocation;
use oxc_react_compiler_hir::ArrayElement;
use oxc_react_compiler_hir::ArrayPattern;
use oxc_react_compiler_hir::BlockId;
use oxc_react_compiler_hir::DeclarationId;
use oxc_react_compiler_hir::FunctionExpressionType;
use oxc_react_compiler_hir::IdentifierId;
use oxc_react_compiler_hir::InstructionKind;
use oxc_react_compiler_hir::InstructionValue;
use oxc_react_compiler_hir::JsxAttribute;
use oxc_react_compiler_hir::JsxTag;
use oxc_react_compiler_hir::LogicalOperator;
use oxc_react_compiler_hir::ObjectPattern;
use oxc_react_compiler_hir::ObjectPropertyKey;
use oxc_react_compiler_hir::ObjectPropertyOrSpread;
use oxc_react_compiler_hir::ObjectPropertyType;
use oxc_react_compiler_hir::ParamPattern;
use oxc_react_compiler_hir::Pattern;
use oxc_react_compiler_hir::Place;
use oxc_react_compiler_hir::PlaceOrSpread;
use oxc_react_compiler_hir::PrimitiveValue;
use oxc_react_compiler_hir::PropertyLiteral;
use oxc_react_compiler_hir::ScopeId;
use oxc_react_compiler_hir::SpreadPattern;
use oxc_react_compiler_hir::environment::Environment;
use oxc_react_compiler_hir::reactive::PrunedReactiveScopeBlock;
use oxc_react_compiler_hir::reactive::ReactiveBlock;
use oxc_react_compiler_hir::reactive::ReactiveFunction;
use oxc_react_compiler_hir::reactive::ReactiveInstruction;
use oxc_react_compiler_hir::reactive::ReactiveScopeBlock;
use oxc_react_compiler_hir::reactive::ReactiveStatement;
use oxc_react_compiler_hir::reactive::ReactiveTerminal;
use oxc_react_compiler_hir::reactive::ReactiveTerminalTargetKind;
use oxc_react_compiler_hir::reactive::ReactiveValue;
...
pub struct OutlinedFunction {
    ...
    pub fn_type: Option<oxc_react_compiler_hir::ReactFunctionType>,
}
...
pub fn codegen_function(
    ...
    if cx.env.hook_guard_name.is_some()
        && cx.env.output_mode == oxc_react_compiler_hir::environment::OutputMode::Client
    {
...
struct Context<'env> {
    ...
    object_methods: HashMap<
        ...
        (
            InstructionValue,
            Option<oxc_react_compiler_diagnostics::SourceLocation>,
        ),
    >,
    unique_identifiers: HashSet<String>,
    fbt_operands: HashSet<IdentifierId>,
...
fn codegen_reactive_scope(
    ...
    if let Some(ref early_return) = early_return_value {
        ...
        let name = match &early_ident.name {
            Some(oxc_react_compiler_hir::IdentifierName::Named(n)) => n.clone(),
            Some(oxc_react_compiler_hir::IdentifierName::Promoted(n)) => n.clone(),
            None => {
...
fn codegen_for_in(
    ...
    Ok(Some(Statement::ForInStatement(ForInStatement {
        ...
        left: Box::new(
            oxc_react_compiler_ast::statements::ForInOfLeft::VariableDeclaration(VariableDeclaration {
                base: BaseNode::typed("VariableDeclaration"),
                declarations: vec![VariableDeclarator {
                    base: BaseNode::typed("VariableDeclarator"),
                    id: lval,
...
fn codegen_store_or_declare(
    ...
    match value {
        ...
        InstructionValue::Destructure {
            ...
            for place in oxc_react_compiler_hir::visitors::each_pattern_operand(&lvalue.pattern) {
                let ident = &cx.env.identifiers[place.identifier.0 as usize];
...
fn codegen_function_expression(
    ...
    lowered_func: &oxc_react_compiler_hir::LoweredFunction,
...
fn codegen_array_pattern(
    ...
    let elements: Vec<Option<PatternLike>> = pattern
        ...
        .iter()
        .map(|item| match item {
            oxc_react_compiler_hir::ArrayPatternElement::Place(place) => {
                Ok(Some(codegen_lvalue(cx, &LvalueRef::Place(place))?))
            }
            oxc_react_compiler_hir::ArrayPatternElement::Spread(spread) => {
                Ok(Some(codegen_lvalue(cx, &LvalueRef::Spread(spread))?))
            }
            oxc_react_compiler_hir::ArrayPatternElement::Hole => Ok(None),
        })
        .collect::<Result<_, CompilerError>>()?;
...
fn codegen_object_pattern(
    ...
    Ok(PatternLike::ObjectPattern(
        oxc_react_compiler_ast::patterns::ObjectPattern {
...
fn codegen_dependency(
    cx: &mut Context,
    dep: &oxc_react_compiler_hir::ReactiveScopeDependency,
) -> Result<Expression, CompilerError> {
...
fn convert_binary_operator(op: &oxc_react_compiler_hir::BinaryOperator) -> AstBinaryOperator {
    match op {
        oxc_react_compiler_hir::BinaryOperator::Equal => AstBinaryOperator::Eq,
        oxc_react_compiler_hir::BinaryOperator::NotEqual => AstBinaryOperator::Neq,
        oxc_react_compiler_hir::BinaryOperator::StrictEqual => AstBinaryOperator::StrictEq,
        oxc_react_compiler_hir::BinaryOperator::StrictNotEqual => AstBinaryOperator::StrictNeq,
        oxc_react_compiler_hir::BinaryOperator::LessThan => AstBinaryOperator::Lt,
        oxc_react_compiler_hir::BinaryOperator::LessEqual => AstBinaryOperator::Lte,
        oxc_react_compiler_hir::BinaryOperator::GreaterThan => AstBinaryOperator::Gt,
        oxc_react_compiler_hir::BinaryOperator::GreaterEqual => AstBinaryOperator::Gte,
        oxc_react_compiler_hir::BinaryOperator::ShiftLeft => AstBinaryOperator::Shl,
        oxc_react_compiler_hir::BinaryOperator::ShiftRight => AstBinaryOperator::Shr,
        oxc_react_compiler_hir::BinaryOperator::UnsignedShiftRight => AstBinaryOperator::UShr,
        oxc_react_compiler_hir::BinaryOperator::Add => AstBinaryOperator::Add,
        oxc_react_compiler_hir::BinaryOperator::Subtract => AstBinaryOperator::Sub,
        oxc_react_compiler_hir::BinaryOperator::Multiply => AstBinaryOperator::Mul,
        oxc_react_compiler_hir::BinaryOperator::Divide => AstBinaryOperator::Div,
        oxc_react_compiler_hir::BinaryOperator::Modulo => AstBinaryOperator::Rem,
        oxc_react_compiler_hir::BinaryOperator::Exponent => AstBinaryOperator::Exp,
        oxc_react_compiler_hir::BinaryOperator::BitwiseOr => AstBinaryOperator::BitOr,
        oxc_react_compiler_hir::BinaryOperator::BitwiseXor => AstBinaryOperator::BitXor,
        oxc_react_compiler_hir::BinaryOperator::BitwiseAnd => AstBinaryOperator::BitAnd,
        oxc_react_compiler_hir::BinaryOperator::In => AstBinaryOperator::In,
        oxc_react_compiler_hir::BinaryOperator::InstanceOf => AstBinaryOperator::Instanceof,
    }
}

fn convert_unary_operator(op: &oxc_react_compiler_hir::UnaryOperator) -> AstUnaryOperator {
    match op {
        oxc_react_compiler_hir::UnaryOperator::Minus => AstUnaryOperator::Neg,
        oxc_react_compiler_hir::UnaryOperator::Plus => AstUnaryOperator::Plus,
        oxc_react_compiler_hir::UnaryOperator::Not => AstUnaryOperator::Not,
        oxc_react_compiler_hir::UnaryOperator::BitwiseNot => AstUnaryOperator::BitNot,
        oxc_react_compiler_hir::UnaryOperator::TypeOf => AstUnaryOperator::TypeOf,
        oxc_react_compiler_hir::UnaryOperator::Void => AstUnaryOperator::Void,
    }
}
...
fn convert_update_operator(op: &oxc_react_compiler_hir::UpdateOperator) -> AstUpdateOperator {
    match op {
        oxc_react_compiler_hir::UpdateOperator::Increment => AstUpdateOperator::Increment,
        oxc_react_compiler_hir::UpdateOperator::Decrement => AstUpdateOperator::Decrement,
    }
}
...
fn invariant_err_with_detail_message(
    ...
    let mut err = CompilerError::new();
    let diagnostic = oxc_react_compiler_diagnostics::CompilerDiagnostic::new(
        ErrorCategory::Invariant,
        reason,
        None::<String>,
    )
...
fn get_statement_loc(stmt: &Statement) -> Option<DiagSourceLocation> {
    ...
    base.loc.as_ref().map(|loc| DiagSourceLocation {
        start: oxc_react_compiler_diagnostics::Position {
            line: loc.start.line,
            column: loc.start.column,
            index: loc.start.index,
        },
        end: oxc_react_compiler_diagnostics::Position {
            line: loc.end.line,
            column: loc.end.column,
            index: loc.end.index,
        },
...
fn compare_scope_dependency(
    a: &oxc_react_compiler_hir::ReactiveScopeDependency,
    b: &oxc_react_compiler_hir::ReactiveScopeDependency,
    env: &Environment,
) -> std::cmp::Ordering {
...
fn dep_to_sort_key(dep: &oxc_react_compiler_hir::ReactiveScopeDependency, env: &Environment) -> String {
...
fn compare_scope_declaration(
    a: &oxc_react_compiler_hir::ReactiveScopeDeclaration,
    b: &oxc_react_compiler_hir::ReactiveScopeDeclaration,
    env: &Environment,
) -> std::cmp::Ordering {
...
fn maybe_wrap_hook_call(
    ...
    if let Some(ref guard_name) = cx.env.hook_guard_name {
        if cx.env.output_mode == oxc_react_compiler_hir::environment::OutputMode::Client
...
fn apply_renames_to_json(
    ...
    renames: &[oxc_react_compiler_hir::environment::BindingRename],
