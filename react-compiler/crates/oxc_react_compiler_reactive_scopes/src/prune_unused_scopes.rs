...
pub fn prune_unused_scopes(func: &mut ReactiveFunction, env: &Environment) -> Result<(), oxc_react_compiler_diagnostics::CompilerError> {
...
fn has_own_declaration(
    scope_data: &oxc_react_compiler_hir::ReactiveScope,
    scope_id: oxc_react_compiler_hir::ScopeId,
) -> bool {
