...
use forked_react_compiler_hir::visitors::{each_instruction_lvalue_ids, each_terminal_operand_ids};
...
pub fn merge_overlapping_reactive_scopes_hir(func: &mut HirFunction, env: &mut Environment) {
    ...
    let mut original_root_range_ids: HashMap<ScopeId, forked_react_compiler_hir::MutableRangeId> = HashMap::new();
