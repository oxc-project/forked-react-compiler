...
use oxc_react_compiler_ast::expressions::{CallExpression, Expression, Identifier};
use oxc_react_compiler_ast::literals::StringLiteral;
use oxc_react_compiler_ast::patterns::{ObjectPattern, ObjectPatternProp, ObjectPatternProperty, PatternLike};
...
use oxc_react_compiler_ast::{Program, SourceType};
use oxc_react_compiler_diagnostics::{CompilerError, CompilerErrorDetail, ErrorCategory, Position, SourceLocation};
...
pub struct ProgramContext {
    ...
    pub renames: Vec<oxc_react_compiler_hir::environment::BindingRename>,
...
impl ProgramContext {
    pub fn new(
        ...
        let react_runtime_module = get_oxc_react_compiler_runtime_module(&opts.target);
...
pub fn get_oxc_react_compiler_runtime_module(target: &CompilerTarget) -> String {
    match target {
