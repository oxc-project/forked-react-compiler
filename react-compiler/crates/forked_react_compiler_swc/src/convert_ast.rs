...
use forked_react_compiler_ast::SourceType;
use forked_react_compiler_ast::common::BaseNode;
use forked_react_compiler_ast::common::Position;
use forked_react_compiler_ast::common::SourceLocation;
use forked_react_compiler_ast::declarations::*;
use forked_react_compiler_ast::expressions::*;
use forked_react_compiler_ast::jsx::*;
use forked_react_compiler_ast::literals::*;
...
fn extract_comments_from_source(source: &str) -> Vec<forked_react_compiler_ast::common::Comment> {
    use forked_react_compiler_ast::common::Comment;
    use forked_react_compiler_ast::common::CommentData;
