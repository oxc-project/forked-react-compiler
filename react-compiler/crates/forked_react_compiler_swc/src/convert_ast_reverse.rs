...
//! Reverse AST converter: forked_react_compiler_ast (Babel format) → SWC AST.
//!
//! This is the inverse of `convert_ast.rs`. It takes a `forked_react_compiler_ast::File`
...
use forked_react_compiler_ast::common::Comment as BabelComment;
use forked_react_compiler_ast::declarations::ExportAllDeclaration;
use forked_react_compiler_ast::declarations::ExportDefaultDecl as BabelExportDefaultDecl;
use forked_react_compiler_ast::declarations::ExportDefaultDeclaration;
use forked_react_compiler_ast::declarations::ExportKind;
use forked_react_compiler_ast::declarations::ExportNamedDeclaration;
use forked_react_compiler_ast::declarations::ImportDeclaration;
use forked_react_compiler_ast::declarations::ImportKind;
use forked_react_compiler_ast::expressions::Expression as BabelExpr;
use forked_react_compiler_ast::expressions::{self as babel_expr};
use forked_react_compiler_ast::operators::*;
use forked_react_compiler_ast::patterns::*;
use forked_react_compiler_ast::statements::Statement as BabelStmt;
use forked_react_compiler_ast::statements::{self as babel_stmt};
use swc_atoms::Atom;
...
/// Convert a `forked_react_compiler_ast::File` into an SWC `Module` and extracted comments.
pub fn convert_program_to_swc(file: &forked_react_compiler_ast::File) -> SwcConversionResult {
...
pub fn convert_program_to_swc_with_source(
    file: &forked_react_compiler_ast::File,
...
impl ReverseCtx {
    ...
    fn extract_source_stmt(&self, base: &forked_react_compiler_ast::common::BaseNode) -> Option<Stmt> {
    ...
    fn parse_ts_stmt(
        &self,
        text: &str,
        base: &forked_react_compiler_ast::common::BaseNode,
    ) -> Option<Stmt> {
    ...
    fn convert_program(&self, program: &forked_react_compiler_ast::Program) -> Module {
    ...
    fn convert_jsx_opening_element(
        &self,
        el: &forked_react_compiler_ast::jsx::JSXOpeningElement,
    ...
    fn convert_jsx_closing_element(
        &self,
        el: &forked_react_compiler_ast::jsx::JSXClosingElement,
    ...
    fn convert_jsx_element_name(
        ...
        match name {
            ...
            forked_react_compiler_ast::jsx::JSXElementName::JSXNamespacedName(ns) => {
    ...
    fn convert_jsx_member_expression(
        &self,
        m: &forked_react_compiler_ast::jsx::JSXMemberExpression,
    ...
    fn convert_jsx_member_expression_object(
        &self,
        obj: &forked_react_compiler_ast::jsx::JSXMemberExprObject,
        ...
        match obj {
            ...
            forked_react_compiler_ast::jsx::JSXMemberExprObject::JSXMemberExpression(m) => {
                let member = self.convert_jsx_member_expression(m);
    ...
    fn convert_jsx_attribute_item(
        &self,
        item: &forked_react_compiler_ast::jsx::JSXAttributeItem,
    ) -> swc_ecma_ast::JSXAttrOrSpread {
        match item {
            forked_react_compiler_ast::jsx::JSXAttributeItem::JSXAttribute(attr) => {
    ...
    fn convert_jsx_attribute_name(
        &self,
        name: &forked_react_compiler_ast::jsx::JSXAttributeName,
    ) -> swc_ecma_ast::JSXAttrName {
        match name {
            forked_react_compiler_ast::jsx::JSXAttributeName::JSXIdentifier(id) => {
                swc_ecma_ast::JSXAttrName::Ident(self.ident_name(&id.name, self.span(&id.base)))
            }
            forked_react_compiler_ast::jsx::JSXAttributeName::JSXNamespacedName(ns) => {
                let namespace = self.ident_name(&ns.namespace.name, self.span(&ns.namespace.base));
                let name = self.ident_name(&ns.name.name, self.span(&ns.name.base));
    ...
    fn convert_jsx_attribute_value(
        &self,
        value: &forked_react_compiler_ast::jsx::JSXAttributeValue,
    ) -> swc_ecma_ast::JSXAttrValue {
        match value {
            forked_react_compiler_ast::jsx::JSXAttributeValue::StringLiteral(s) => {
            ...
            forked_react_compiler_ast::jsx::JSXAttributeValue::JSXExpressionContainer(ec) => {
            ...
            forked_react_compiler_ast::jsx::JSXAttributeValue::JSXFragment(frag) => {
                let fragment = self.convert_jsx_fragment(frag);
    ...
    fn convert_jsx_expression_container_expr(
        &self,
        expr: &forked_react_compiler_ast::jsx::JSXExpressionContainerExpr,
    ) -> swc_ecma_ast::JSXExpr {
        match expr {
            forked_react_compiler_ast::jsx::JSXExpressionContainerExpr::JSXEmptyExpression(e) => {
                swc_ecma_ast::JSXExpr::JSXEmptyExpr(swc_ecma_ast::JSXEmptyExpr {
                    span: self.span(&e.base),
                })
            }
            forked_react_compiler_ast::jsx::JSXExpressionContainerExpr::Expression(e) => {
    ...
    fn convert_jsx_child(
        ...
        match child {
            forked_react_compiler_ast::jsx::JSXChild::JSXText(t) => {
            ...
            forked_react_compiler_ast::jsx::JSXChild::JSXExpressionContainer(ec) => {
                let expr = self.convert_jsx_expression_container_expr(&ec.expression);
    ...
    fn convert_jsx_fragment(
        &self,
        frag: &forked_react_compiler_ast::jsx::JSXFragment,
    ...
    fn convert_import_specifier(
        &self,
        spec: &forked_react_compiler_ast::declarations::ImportSpecifier,
    ) -> swc_ecma_ast::ImportSpecifier {
        match spec {
            forked_react_compiler_ast::declarations::ImportSpecifier::ImportSpecifier(s) => {
                ...
                let imported_name = match &s.imported {
                    forked_react_compiler_ast::declarations::ModuleExportName::Identifier(id) => {
                        Some(&id.name)
                    }
                    forked_react_compiler_ast::declarations::ModuleExportName::StringLiteral(_) => None,
                };
            ...
            forked_react_compiler_ast::declarations::ImportSpecifier::ImportDefaultSpecifier(s) => {
                let local = self.ident(&s.local.name, self.span(&s.local.base));
            ...
            forked_react_compiler_ast::declarations::ImportSpecifier::ImportNamespaceSpecifier(s) => {
                let local = self.ident(&s.local.name, self.span(&s.local.base));
    ...
    fn convert_module_export_name(
        &self,
        name: &forked_react_compiler_ast::declarations::ModuleExportName,
    ) -> swc_ecma_ast::ModuleExportName {
        match name {
            forked_react_compiler_ast::declarations::ModuleExportName::Identifier(id) => {
                swc_ecma_ast::ModuleExportName::Ident(self.ident(&id.name, self.span(&id.base)))
            }
            forked_react_compiler_ast::declarations::ModuleExportName::StringLiteral(s) => {
    ...
    fn convert_declaration(&self, decl: &forked_react_compiler_ast::declarations::Declaration) -> Decl {
        match decl {
            forked_react_compiler_ast::declarations::Declaration::FunctionDeclaration(f) => {
                Decl::Fn(self.convert_function_declaration(f))
            }
            forked_react_compiler_ast::declarations::Declaration::VariableDeclaration(v) => {
                Decl::Var(Box::new(self.convert_variable_declaration(v)))
            }
            forked_react_compiler_ast::declarations::Declaration::ClassDeclaration(c) => {
                let ident =
                    c.id.as_ref()
                        .map(|id| self.ident(&id.name, self.span(&id.base)))
                        .unwrap_or_else(|| self.ident("_anonymous", DUMMY_SP));
    ...
    fn convert_export_specifier(
        &self,
        spec: &forked_react_compiler_ast::declarations::ExportSpecifier,
    ) -> swc_ecma_ast::ExportSpecifier {
        match spec {
            forked_react_compiler_ast::declarations::ExportSpecifier::ExportSpecifier(s) => {
            ...
            forked_react_compiler_ast::declarations::ExportSpecifier::ExportDefaultSpecifier(s) => {
            ...
            forked_react_compiler_ast::declarations::ExportSpecifier::ExportNamespaceSpecifier(s) => {
