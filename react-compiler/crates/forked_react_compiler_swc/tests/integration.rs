...
use forked_react_compiler::entrypoint::plugin_options::CompilerTarget;
use forked_react_compiler::entrypoint::plugin_options::PluginOptions;
use forked_react_compiler_ast::scope::BindingKind;
use forked_react_compiler_ast::scope::ScopeKind;
use forked_react_compiler_ast::statements::Statement;
use forked_react_compiler_swc::convert_ast::convert_module;
use forked_react_compiler_swc::convert_ast_reverse::convert_program_to_swc;
use forked_react_compiler_swc::convert_scope::build_scope_info;
use forked_react_compiler_swc::lint_source;
use forked_react_compiler_swc::prefilter::has_react_like_functions;
use forked_react_compiler_swc::transform_source;
...
fn reverse_convert_roundtrip_via_json() {
    ...
    let deserialized: forked_react_compiler_ast::File =
