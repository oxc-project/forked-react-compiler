...
use forked_react_compiler_diagnostics::{CompilerDiagnostic, CompilerDiagnosticDetail, ErrorCategory, SourceLocation};
...
impl<'a, 'b> Driver<'a, 'b> {
    ...
    fn extract_value_block_result(
        &self,
        instructions: &[forked_react_compiler_hir::InstructionId],
        block_id: BlockId,
        loc: Option<SourceLocation>,
    ) -> ValueBlockResult {
    ...
    fn value_block_result_to_sequence(
        ...
        ReactiveValue::SequenceExpression {
            ...
            value: Box::new(ReactiveValue::Instruction(InstructionValue::Primitive {
                value: forked_react_compiler_hir::PrimitiveValue::Undefined,
                loc,
            })),
            loc,
        }
