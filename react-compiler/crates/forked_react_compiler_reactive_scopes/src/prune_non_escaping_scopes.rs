...
use forked_react_compiler_hir::ArrayPatternElement;
...
use forked_react_compiler_hir::ReactiveInstruction;
use forked_react_compiler_hir::ReactiveScopeBlock;
use forked_react_compiler_hir::ReactiveStatement;
use forked_react_compiler_hir::ReactiveTerminal;
use forked_react_compiler_hir::ReactiveTerminalStatement;
...
use forked_react_compiler_hir::visitors::each_instruction_value_operand;
...
pub fn prune_non_escaping_scopes(
    ...
    env: &mut Environment,
) -> Result<(), forked_react_compiler_diagnostics::CompilerError> {
    ...
    for param in &func.params {
        let place = match param {
            forked_react_compiler_hir::ParamPattern::Place(p) => p,
            forked_react_compiler_hir::ParamPattern::Spread(s) => &s.place,
        };
...
impl<'a> ReactiveFunctionTransform for PruneScopesTransform<'a> {
    ...
    ) -> Result<Transformed<ReactiveStatement>, forked_react_compiler_diagnostics::CompilerError> {
