...
fn is_stable_ref_type(
    ty: &forked_react_compiler_hir::Type,
...
/// TS: `isStableType`
fn is_stable_type(ty: &forked_react_compiler_hir::Type) -> bool {
...
fn is_set_state_type(ty: &forked_react_compiler_hir::Type) -> bool {
    matches!(ty, forked_react_compiler_hir::Type::Function { shape_id: Some(id), .. } if id == object_shape::BUILT_IN_SET_STATE_ID)
}

fn is_set_action_state_type(ty: &forked_react_compiler_hir::Type) -> bool {
    matches!(ty, forked_react_compiler_hir::Type::Function { shape_id: Some(id), .. } if id == object_shape::BUILT_IN_SET_ACTION_STATE_ID)
}

fn is_dispatcher_type(ty: &forked_react_compiler_hir::Type) -> bool {
    matches!(ty, forked_react_compiler_hir::Type::Function { shape_id: Some(id), .. } if id == object_shape::BUILT_IN_DISPATCH_ID)
}

fn is_start_transition_type(ty: &forked_react_compiler_hir::Type) -> bool {
    matches!(ty, forked_react_compiler_hir::Type::Function { shape_id: Some(id), .. } if id == object_shape::BUILT_IN_START_TRANSITION_ID)
}

fn is_set_optimistic_type(ty: &forked_react_compiler_hir::Type) -> bool {
    matches!(ty, forked_react_compiler_hir::Type::Function { shape_id: Some(id), .. } if id == object_shape::BUILT_IN_SET_OPTIMISTIC_ID)
}
