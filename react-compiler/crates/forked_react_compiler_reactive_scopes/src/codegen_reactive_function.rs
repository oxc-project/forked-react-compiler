...
use forked_react_compiler_ast::common::BaseNode;
use forked_react_compiler_ast::common::Position as AstPosition;
use forked_react_compiler_ast::common::SourceLocation as AstSourceLocation;
use forked_react_compiler_ast::expressions::ArrowFunctionBody;
use forked_react_compiler_ast::expressions::Expression;
use forked_react_compiler_ast::expressions::Identifier as AstIdentifier;
use forked_react_compiler_ast::expressions::{self as ast_expr};
use forked_react_compiler_ast::jsx::JSXAttribute as AstJSXAttribute;
...
use forked_react_compiler_ast::jsx::JSXClosingElement;
use forked_react_compiler_ast::jsx::JSXClosingFragment;
use forked_react_compiler_ast::jsx::JSXElement;
use forked_react_compiler_ast::jsx::JSXElementName;
use forked_react_compiler_ast::jsx::JSXExpressionContainer;
use forked_react_compiler_ast::jsx::JSXExpressionContainerExpr;
use forked_react_compiler_ast::jsx::JSXFragment;
use forked_react_compiler_ast::jsx::JSXIdentifier;
use forked_react_compiler_ast::jsx::JSXMemberExprObject;
use forked_react_compiler_ast::jsx::JSXMemberExpression;
use forked_react_compiler_ast::jsx::JSXNamespacedName;
use forked_react_compiler_ast::jsx::JSXOpeningElement;
use forked_react_compiler_ast::jsx::JSXOpeningFragment;
use forked_react_compiler_ast::jsx::JSXSpreadAttribute;
use forked_react_compiler_ast::jsx::JSXText;
use forked_react_compiler_ast::literals::BooleanLiteral;
use forked_react_compiler_ast::literals::NullLiteral;
use forked_react_compiler_ast::literals::NumericLiteral;
use forked_react_compiler_ast::literals::RegExpLiteral as AstRegExpLiteral;
use forked_react_compiler_ast::literals::StringLiteral;
use forked_react_compiler_ast::literals::TemplateElement;
use forked_react_compiler_ast::literals::TemplateElementValue;
use forked_react_compiler_ast::operators::AssignmentOperator;
use forked_react_compiler_ast::operators::BinaryOperator as AstBinaryOperator;
use forked_react_compiler_ast::operators::LogicalOperator as AstLogicalOperator;
use forked_react_compiler_ast::operators::UnaryOperator as AstUnaryOperator;
use forked_react_compiler_ast::operators::UpdateOperator as AstUpdateOperator;
use forked_react_compiler_ast::patterns::ArrayPattern as AstArrayPattern;
use forked_react_compiler_ast::patterns::ObjectPatternProp;
use forked_react_compiler_ast::patterns::ObjectPatternProperty;
use forked_react_compiler_ast::patterns::PatternLike;
use forked_react_compiler_ast::patterns::RestElement;
use forked_react_compiler_ast::statements::BlockStatement;
use forked_react_compiler_ast::statements::BreakStatement;
use forked_react_compiler_ast::statements::CatchClause;
use forked_react_compiler_ast::statements::ContinueStatement;
use forked_react_compiler_ast::statements::DebuggerStatement;
use forked_react_compiler_ast::statements::Directive;
use forked_react_compiler_ast::statements::DirectiveLiteral;
use forked_react_compiler_ast::statements::DoWhileStatement;
use forked_react_compiler_ast::statements::EmptyStatement;
use forked_react_compiler_ast::statements::ExpressionStatement;
use forked_react_compiler_ast::statements::ForInStatement;
use forked_react_compiler_ast::statements::ForInit;
use forked_react_compiler_ast::statements::ForOfStatement;
use forked_react_compiler_ast::statements::ForStatement;
use forked_react_compiler_ast::statements::FunctionDeclaration;
use forked_react_compiler_ast::statements::IfStatement;
use forked_react_compiler_ast::statements::LabeledStatement;
use forked_react_compiler_ast::statements::ReturnStatement;
use forked_react_compiler_ast::statements::Statement;
use forked_react_compiler_ast::statements::SwitchCase;
use forked_react_compiler_ast::statements::SwitchStatement;
use forked_react_compiler_ast::statements::ThrowStatement;
use forked_react_compiler_ast::statements::TryStatement;
use forked_react_compiler_ast::statements::VariableDeclaration;
use forked_react_compiler_ast::statements::VariableDeclarationKind;
use forked_react_compiler_ast::statements::VariableDeclarator;
use forked_react_compiler_ast::statements::WhileStatement;
...
use forked_react_compiler_diagnostics::SourceLocation as DiagSourceLocation;
use forked_react_compiler_hir::ArrayElement;
use forked_react_compiler_hir::ArrayPattern;
use forked_react_compiler_hir::BlockId;
use forked_react_compiler_hir::DeclarationId;
use forked_react_compiler_hir::FunctionExpressionType;
use forked_react_compiler_hir::IdentifierId;
use forked_react_compiler_hir::InstructionKind;
use forked_react_compiler_hir::InstructionValue;
use forked_react_compiler_hir::JsxAttribute;
use forked_react_compiler_hir::JsxTag;
use forked_react_compiler_hir::LogicalOperator;
use forked_react_compiler_hir::ObjectPattern;
use forked_react_compiler_hir::ObjectPropertyKey;
use forked_react_compiler_hir::ObjectPropertyOrSpread;
use forked_react_compiler_hir::ObjectPropertyType;
use forked_react_compiler_hir::ParamPattern;
use forked_react_compiler_hir::Pattern;
use forked_react_compiler_hir::Place;
use forked_react_compiler_hir::PlaceOrSpread;
use forked_react_compiler_hir::PrimitiveValue;
use forked_react_compiler_hir::PropertyLiteral;
use forked_react_compiler_hir::ScopeId;
use forked_react_compiler_hir::SpreadPattern;
use forked_react_compiler_hir::environment::Environment;
use forked_react_compiler_hir::reactive::PrunedReactiveScopeBlock;
use forked_react_compiler_hir::reactive::ReactiveBlock;
use forked_react_compiler_hir::reactive::ReactiveFunction;
use forked_react_compiler_hir::reactive::ReactiveInstruction;
use forked_react_compiler_hir::reactive::ReactiveScopeBlock;
use forked_react_compiler_hir::reactive::ReactiveStatement;
use forked_react_compiler_hir::reactive::ReactiveTerminal;
use forked_react_compiler_hir::reactive::ReactiveTerminalTargetKind;
use forked_react_compiler_hir::reactive::ReactiveValue;
...
pub struct OutlinedFunction {
    ...
    pub fn_type: Option<forked_react_compiler_hir::ReactFunctionType>,
}
...
pub fn codegen_function(
    ...
    if cx.env.hook_guard_name.is_some()
        && cx.env.output_mode == forked_react_compiler_hir::environment::OutputMode::Client
    {
...
struct Context<'env> {
    ...
    object_methods: HashMap<
        ...
        (
            InstructionValue,
            Option<forked_react_compiler_diagnostics::SourceLocation>,
        ),
    >,
    unique_identifiers: HashSet<String>,
    fbt_operands: HashSet<IdentifierId>,
...
fn codegen_reactive_scope(
    ...
    if let Some(ref early_return) = early_return_value {
        ...
        let name = match &early_ident.name {
            Some(forked_react_compiler_hir::IdentifierName::Named(n)) => n.clone(),
            Some(forked_react_compiler_hir::IdentifierName::Promoted(n)) => n.clone(),
            None => {
...
fn codegen_for_in(
    ...
    Ok(Some(Statement::ForInStatement(ForInStatement {
        ...
        left: Box::new(
            forked_react_compiler_ast::statements::ForInOfLeft::VariableDeclaration(VariableDeclaration {
                base: BaseNode::typed("VariableDeclaration"),
                declarations: vec![VariableDeclarator {
                    base: BaseNode::typed("VariableDeclarator"),
                    id: lval,
...
fn codegen_store_or_declare(
    ...
    match value {
        ...
        InstructionValue::Destructure {
            ...
            for place in forked_react_compiler_hir::visitors::each_pattern_operand(&lvalue.pattern) {
                let ident = &cx.env.identifiers[place.identifier.0 as usize];
...
fn codegen_function_expression(
    ...
    lowered_func: &forked_react_compiler_hir::LoweredFunction,
...
fn codegen_array_pattern(
    ...
    let elements: Vec<Option<PatternLike>> = pattern
        ...
        .iter()
        .map(|item| match item {
            forked_react_compiler_hir::ArrayPatternElement::Place(place) => {
                Ok(Some(codegen_lvalue(cx, &LvalueRef::Place(place))?))
            }
            forked_react_compiler_hir::ArrayPatternElement::Spread(spread) => {
                Ok(Some(codegen_lvalue(cx, &LvalueRef::Spread(spread))?))
            }
            forked_react_compiler_hir::ArrayPatternElement::Hole => Ok(None),
        })
        .collect::<Result<_, CompilerError>>()?;
...
fn codegen_object_pattern(
    ...
    Ok(PatternLike::ObjectPattern(
        forked_react_compiler_ast::patterns::ObjectPattern {
...
fn codegen_dependency(
    cx: &mut Context,
    dep: &forked_react_compiler_hir::ReactiveScopeDependency,
) -> Result<Expression, CompilerError> {
...
fn convert_binary_operator(op: &forked_react_compiler_hir::BinaryOperator) -> AstBinaryOperator {
    match op {
        forked_react_compiler_hir::BinaryOperator::Equal => AstBinaryOperator::Eq,
        forked_react_compiler_hir::BinaryOperator::NotEqual => AstBinaryOperator::Neq,
        forked_react_compiler_hir::BinaryOperator::StrictEqual => AstBinaryOperator::StrictEq,
        forked_react_compiler_hir::BinaryOperator::StrictNotEqual => AstBinaryOperator::StrictNeq,
        forked_react_compiler_hir::BinaryOperator::LessThan => AstBinaryOperator::Lt,
        forked_react_compiler_hir::BinaryOperator::LessEqual => AstBinaryOperator::Lte,
        forked_react_compiler_hir::BinaryOperator::GreaterThan => AstBinaryOperator::Gt,
        forked_react_compiler_hir::BinaryOperator::GreaterEqual => AstBinaryOperator::Gte,
        forked_react_compiler_hir::BinaryOperator::ShiftLeft => AstBinaryOperator::Shl,
        forked_react_compiler_hir::BinaryOperator::ShiftRight => AstBinaryOperator::Shr,
        forked_react_compiler_hir::BinaryOperator::UnsignedShiftRight => AstBinaryOperator::UShr,
        forked_react_compiler_hir::BinaryOperator::Add => AstBinaryOperator::Add,
        forked_react_compiler_hir::BinaryOperator::Subtract => AstBinaryOperator::Sub,
        forked_react_compiler_hir::BinaryOperator::Multiply => AstBinaryOperator::Mul,
        forked_react_compiler_hir::BinaryOperator::Divide => AstBinaryOperator::Div,
        forked_react_compiler_hir::BinaryOperator::Modulo => AstBinaryOperator::Rem,
        forked_react_compiler_hir::BinaryOperator::Exponent => AstBinaryOperator::Exp,
        forked_react_compiler_hir::BinaryOperator::BitwiseOr => AstBinaryOperator::BitOr,
        forked_react_compiler_hir::BinaryOperator::BitwiseXor => AstBinaryOperator::BitXor,
        forked_react_compiler_hir::BinaryOperator::BitwiseAnd => AstBinaryOperator::BitAnd,
        forked_react_compiler_hir::BinaryOperator::In => AstBinaryOperator::In,
        forked_react_compiler_hir::BinaryOperator::InstanceOf => AstBinaryOperator::Instanceof,
    }
}

fn convert_unary_operator(op: &forked_react_compiler_hir::UnaryOperator) -> AstUnaryOperator {
    match op {
        forked_react_compiler_hir::UnaryOperator::Minus => AstUnaryOperator::Neg,
        forked_react_compiler_hir::UnaryOperator::Plus => AstUnaryOperator::Plus,
        forked_react_compiler_hir::UnaryOperator::Not => AstUnaryOperator::Not,
        forked_react_compiler_hir::UnaryOperator::BitwiseNot => AstUnaryOperator::BitNot,
        forked_react_compiler_hir::UnaryOperator::TypeOf => AstUnaryOperator::TypeOf,
        forked_react_compiler_hir::UnaryOperator::Void => AstUnaryOperator::Void,
    }
}
...
fn convert_update_operator(op: &forked_react_compiler_hir::UpdateOperator) -> AstUpdateOperator {
    match op {
        forked_react_compiler_hir::UpdateOperator::Increment => AstUpdateOperator::Increment,
        forked_react_compiler_hir::UpdateOperator::Decrement => AstUpdateOperator::Decrement,
    }
}
...
fn invariant_err_with_detail_message(
    ...
    let mut err = CompilerError::new();
    let diagnostic = forked_react_compiler_diagnostics::CompilerDiagnostic::new(
        ErrorCategory::Invariant,
        reason,
        None::<String>,
    )
...
fn get_statement_loc(stmt: &Statement) -> Option<DiagSourceLocation> {
    ...
    base.loc.as_ref().map(|loc| DiagSourceLocation {
        start: forked_react_compiler_diagnostics::Position {
            line: loc.start.line,
            column: loc.start.column,
            index: loc.start.index,
        },
        end: forked_react_compiler_diagnostics::Position {
            line: loc.end.line,
            column: loc.end.column,
            index: loc.end.index,
        },
...
fn compare_scope_dependency(
    a: &forked_react_compiler_hir::ReactiveScopeDependency,
    b: &forked_react_compiler_hir::ReactiveScopeDependency,
    env: &Environment,
) -> std::cmp::Ordering {
...
fn dep_to_sort_key(dep: &forked_react_compiler_hir::ReactiveScopeDependency, env: &Environment) -> String {
...
fn compare_scope_declaration(
    a: &forked_react_compiler_hir::ReactiveScopeDeclaration,
    b: &forked_react_compiler_hir::ReactiveScopeDeclaration,
    env: &Environment,
) -> std::cmp::Ordering {
...
fn maybe_wrap_hook_call(
    ...
    if let Some(ref guard_name) = cx.env.hook_guard_name {
        if cx.env.output_mode == forked_react_compiler_hir::environment::OutputMode::Client
...
fn apply_renames_to_json(
    ...
    renames: &[forked_react_compiler_hir::environment::BindingRename],
