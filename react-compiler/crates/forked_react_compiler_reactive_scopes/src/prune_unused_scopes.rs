...
pub fn prune_unused_scopes(func: &mut ReactiveFunction, env: &Environment) -> Result<(), forked_react_compiler_diagnostics::CompilerError> {
...
fn has_own_declaration(
    scope_data: &forked_react_compiler_hir::ReactiveScope,
    scope_id: forked_react_compiler_hir::ScopeId,
) -> bool {
