...
use oxc_react_compiler::entrypoint::compile_result::{
...
fn error_info_to_diagnostic(error: &oxc_react_compiler::entrypoint::compile_result::CompilerErrorInfo) -> OxcDiagnostic {
