...
//! Reverse AST converter: oxc_react_compiler_ast (Babel format) → OXC AST.
//!
...
use oxc_react_compiler_ast::declarations::*;
use oxc_react_compiler_ast::expressions::*;
use oxc_react_compiler_ast::jsx::*;
...
/// Convert a `oxc_react_compiler_ast::File` into an OXC `Program` allocated in the given arena.
...
impl<'a> ReverseCtx<'a> {
    ...
    fn convert_program(&self, program: &oxc_react_compiler_ast::Program) -> oxc::Program<'a> {
        let source_type = match program.source_type {
            oxc_react_compiler_ast::SourceType::Module => oxc_span::SourceType::mjs(),
            oxc_react_compiler_ast::SourceType::Script => oxc_span::SourceType::cjs(),
        };
    ...
    fn convert_template_literal(
        &self,
        tl: &oxc_react_compiler_ast::expressions::TemplateLiteral,
    ...
    fn convert_class_to_oxc(
        &self,
        c: &oxc_react_compiler_ast::expressions::ClassExpression,
