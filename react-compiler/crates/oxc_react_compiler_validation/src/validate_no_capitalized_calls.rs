...
use oxc_react_compiler_diagnostics::{CompilerError, CompilerErrorDetail, ErrorCategory};
use oxc_react_compiler_hir::environment::Environment;
use oxc_react_compiler_hir::{HirFunction, IdentifierId, InstructionValue, PropertyLiteral};
