...
use oxc_react_compiler::entrypoint::plugin_options::CompilerTarget;
use oxc_react_compiler::entrypoint::plugin_options::PluginOptions;
use oxc_react_compiler_ast::scope::BindingKind;
use oxc_react_compiler_ast::scope::ScopeKind;
use oxc_react_compiler_ast::statements::Statement;
use oxc_react_compiler_swc::convert_ast::convert_module;
use oxc_react_compiler_swc::convert_ast_reverse::convert_program_to_swc;
use oxc_react_compiler_swc::convert_scope::build_scope_info;
use oxc_react_compiler_swc::lint_source;
use oxc_react_compiler_swc::prefilter::has_react_like_functions;
use oxc_react_compiler_swc::transform_source;
...
fn reverse_convert_roundtrip_via_json() {
    ...
    let deserialized: oxc_react_compiler_ast::File =
