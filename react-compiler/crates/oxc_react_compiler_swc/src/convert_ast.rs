...
use oxc_react_compiler_ast::SourceType;
use oxc_react_compiler_ast::common::BaseNode;
use oxc_react_compiler_ast::common::Position;
use oxc_react_compiler_ast::common::SourceLocation;
use oxc_react_compiler_ast::declarations::*;
use oxc_react_compiler_ast::expressions::*;
use oxc_react_compiler_ast::jsx::*;
use oxc_react_compiler_ast::literals::*;
...
fn extract_comments_from_source(source: &str) -> Vec<oxc_react_compiler_ast::common::Comment> {
    use oxc_react_compiler_ast::common::Comment;
    use oxc_react_compiler_ast::common::CommentData;
