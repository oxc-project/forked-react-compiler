...
//! Reverse AST converter: oxc_react_compiler_ast (Babel format) → SWC AST.
//!
//! This is the inverse of `convert_ast.rs`. It takes a `oxc_react_compiler_ast::File`
...
use oxc_react_compiler_ast::common::Comment as BabelComment;
use oxc_react_compiler_ast::declarations::ExportAllDeclaration;
use oxc_react_compiler_ast::declarations::ExportDefaultDecl as BabelExportDefaultDecl;
use oxc_react_compiler_ast::declarations::ExportDefaultDeclaration;
use oxc_react_compiler_ast::declarations::ExportKind;
use oxc_react_compiler_ast::declarations::ExportNamedDeclaration;
use oxc_react_compiler_ast::declarations::ImportDeclaration;
use oxc_react_compiler_ast::declarations::ImportKind;
use oxc_react_compiler_ast::expressions::Expression as BabelExpr;
use oxc_react_compiler_ast::expressions::{self as babel_expr};
use oxc_react_compiler_ast::operators::*;
use oxc_react_compiler_ast::patterns::*;
use oxc_react_compiler_ast::statements::Statement as BabelStmt;
use oxc_react_compiler_ast::statements::{self as babel_stmt};
use swc_atoms::Atom;
...
/// Convert a `oxc_react_compiler_ast::File` into an SWC `Module` and extracted comments.
pub fn convert_program_to_swc(file: &oxc_react_compiler_ast::File) -> SwcConversionResult {
...
impl ReverseCtx {
    ...
    fn extract_source_stmt(&self, base: &oxc_react_compiler_ast::common::BaseNode) -> Option<Stmt> {
    ...
    fn parse_ts_stmt(
        &self,
        text: &str,
        base: &oxc_react_compiler_ast::common::BaseNode,
    ) -> Option<Stmt> {
    ...
    fn convert_program(&self, program: &oxc_react_compiler_ast::Program) -> Module {
    ...
    fn convert_jsx_opening_element(
        &self,
        el: &oxc_react_compiler_ast::jsx::JSXOpeningElement,
    ...
    fn convert_jsx_closing_element(
        &self,
        el: &oxc_react_compiler_ast::jsx::JSXClosingElement,
    ...
    fn convert_jsx_element_name(
        ...
        match name {
            ...
            oxc_react_compiler_ast::jsx::JSXElementName::JSXNamespacedName(ns) => {
    ...
    fn convert_jsx_member_expression(
        &self,
        m: &oxc_react_compiler_ast::jsx::JSXMemberExpression,
    ...
    fn convert_jsx_member_expression_object(
        &self,
        obj: &oxc_react_compiler_ast::jsx::JSXMemberExprObject,
        ...
        match obj {
            ...
            oxc_react_compiler_ast::jsx::JSXMemberExprObject::JSXMemberExpression(m) => {
                let member = self.convert_jsx_member_expression(m);
    ...
    fn convert_jsx_attribute_item(
        &self,
        item: &oxc_react_compiler_ast::jsx::JSXAttributeItem,
    ) -> swc_ecma_ast::JSXAttrOrSpread {
        match item {
            oxc_react_compiler_ast::jsx::JSXAttributeItem::JSXAttribute(attr) => {
    ...
    fn convert_jsx_attribute_name(
        &self,
        name: &oxc_react_compiler_ast::jsx::JSXAttributeName,
    ) -> swc_ecma_ast::JSXAttrName {
        match name {
            oxc_react_compiler_ast::jsx::JSXAttributeName::JSXIdentifier(id) => {
                swc_ecma_ast::JSXAttrName::Ident(self.ident_name(&id.name, self.span(&id.base)))
            }
            oxc_react_compiler_ast::jsx::JSXAttributeName::JSXNamespacedName(ns) => {
                let namespace = self.ident_name(&ns.namespace.name, self.span(&ns.namespace.base));
                let name = self.ident_name(&ns.name.name, self.span(&ns.name.base));
    ...
    fn convert_jsx_attribute_value(
        &self,
        value: &oxc_react_compiler_ast::jsx::JSXAttributeValue,
    ) -> swc_ecma_ast::JSXAttrValue {
        match value {
            oxc_react_compiler_ast::jsx::JSXAttributeValue::StringLiteral(s) => {
            ...
            oxc_react_compiler_ast::jsx::JSXAttributeValue::JSXExpressionContainer(ec) => {
            ...
            oxc_react_compiler_ast::jsx::JSXAttributeValue::JSXFragment(frag) => {
                let fragment = self.convert_jsx_fragment(frag);
    ...
    fn convert_jsx_expression_container_expr(
        &self,
        expr: &oxc_react_compiler_ast::jsx::JSXExpressionContainerExpr,
    ) -> swc_ecma_ast::JSXExpr {
        match expr {
            oxc_react_compiler_ast::jsx::JSXExpressionContainerExpr::JSXEmptyExpression(e) => {
                swc_ecma_ast::JSXExpr::JSXEmptyExpr(swc_ecma_ast::JSXEmptyExpr {
                    span: self.span(&e.base),
                })
            }
            oxc_react_compiler_ast::jsx::JSXExpressionContainerExpr::Expression(e) => {
    ...
    fn convert_jsx_child(
        ...
        match child {
            oxc_react_compiler_ast::jsx::JSXChild::JSXText(t) => {
            ...
            oxc_react_compiler_ast::jsx::JSXChild::JSXExpressionContainer(ec) => {
                let expr = self.convert_jsx_expression_container_expr(&ec.expression);
    ...
    fn convert_jsx_fragment(
        &self,
        frag: &oxc_react_compiler_ast::jsx::JSXFragment,
    ...
    fn convert_import_specifier(
        &self,
        spec: &oxc_react_compiler_ast::declarations::ImportSpecifier,
    ) -> swc_ecma_ast::ImportSpecifier {
        match spec {
            oxc_react_compiler_ast::declarations::ImportSpecifier::ImportSpecifier(s) => {
                ...
                let imported_name = match &s.imported {
                    oxc_react_compiler_ast::declarations::ModuleExportName::Identifier(id) => {
                        Some(&id.name)
                    }
                    oxc_react_compiler_ast::declarations::ModuleExportName::StringLiteral(_) => None,
                };
            ...
            oxc_react_compiler_ast::declarations::ImportSpecifier::ImportDefaultSpecifier(s) => {
                let local = self.ident(&s.local.name, self.span(&s.local.base));
            ...
            oxc_react_compiler_ast::declarations::ImportSpecifier::ImportNamespaceSpecifier(s) => {
                let local = self.ident(&s.local.name, self.span(&s.local.base));
    ...
    fn convert_module_export_name(
        &self,
        name: &oxc_react_compiler_ast::declarations::ModuleExportName,
    ) -> swc_ecma_ast::ModuleExportName {
        match name {
            oxc_react_compiler_ast::declarations::ModuleExportName::Identifier(id) => {
                swc_ecma_ast::ModuleExportName::Ident(self.ident(&id.name, self.span(&id.base)))
            }
            oxc_react_compiler_ast::declarations::ModuleExportName::StringLiteral(s) => {
    ...
    fn convert_declaration(&self, decl: &oxc_react_compiler_ast::declarations::Declaration) -> Decl {
        match decl {
            oxc_react_compiler_ast::declarations::Declaration::FunctionDeclaration(f) => {
                Decl::Fn(self.convert_function_declaration(f))
            }
            oxc_react_compiler_ast::declarations::Declaration::VariableDeclaration(v) => {
                Decl::Var(Box::new(self.convert_variable_declaration(v)))
            }
            oxc_react_compiler_ast::declarations::Declaration::ClassDeclaration(c) => {
                let ident =
                    c.id.as_ref()
                        .map(|id| self.ident(&id.name, self.span(&id.base)))
                        .unwrap_or_else(|| self.ident("_anonymous", DUMMY_SP));
    ...
    fn convert_export_specifier(
        &self,
        spec: &oxc_react_compiler_ast::declarations::ExportSpecifier,
    ) -> swc_ecma_ast::ExportSpecifier {
        match spec {
            oxc_react_compiler_ast::declarations::ExportSpecifier::ExportSpecifier(s) => {
            ...
            oxc_react_compiler_ast::declarations::ExportSpecifier::ExportDefaultSpecifier(s) => {
            ...
            oxc_react_compiler_ast::declarations::ExportSpecifier::ExportNamespaceSpecifier(s) => {
