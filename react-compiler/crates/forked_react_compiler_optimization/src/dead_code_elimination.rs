...
use forked_react_compiler_hir::environment::{Environment, OutputMode};
...
pub fn dead_code_elimination(func: &mut HirFunction, env: &Environment) {
    ...
    let mut instructions_to_rewrite: Vec<forked_react_compiler_hir::InstructionId> = Vec::new();
...
fn rewrite_instruction(
    ...
    instr_id: forked_react_compiler_hir::InstructionId,
    state: &State,
    env: &Environment,
) {
