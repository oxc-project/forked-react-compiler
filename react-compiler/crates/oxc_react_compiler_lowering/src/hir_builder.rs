...
use oxc_react_compiler_ast::scope::ImportBindingKind;
...
use oxc_react_compiler_hir::visitors::each_terminal_successor;
use oxc_react_compiler_hir::visitors::terminal_fallthrough;
    ...
    pub fn resolve_binding_with_loc(
        ...
        if candidate != name {
            ...
            if let Some(decl_start) = binding.declaration_start {
                self.env
                    .renames
                    .push(oxc_react_compiler_hir::environment::BindingRename {
