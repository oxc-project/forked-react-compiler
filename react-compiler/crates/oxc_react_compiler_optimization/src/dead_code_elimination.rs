...
use oxc_react_compiler_hir::environment::{Environment, OutputMode};
...
pub fn dead_code_elimination(func: &mut HirFunction, env: &Environment) {
    ...
    let mut instructions_to_rewrite: Vec<oxc_react_compiler_hir::InstructionId> = Vec::new();
...
fn rewrite_instruction(
    ...
    instr_id: oxc_react_compiler_hir::InstructionId,
    state: &State,
    env: &Environment,
) {
