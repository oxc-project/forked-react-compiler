...
use oxc_react_compiler_hir::DependencyPathEntry;
...
use oxc_react_compiler_hir::Instruction;
use oxc_react_compiler_hir::InstructionId;
use oxc_react_compiler_hir::InstructionValue;
use oxc_react_compiler_hir::ManualMemoDependency;
use oxc_react_compiler_hir::ManualMemoDependencyRoot;
use oxc_react_compiler_hir::NonLocalBinding;
...
use oxc_react_compiler_lowering::create_temporary_place;
use oxc_react_compiler_lowering::mark_instruction_ids;
