    ...
    F: FnMut(&HirFunction, &Environment),
{
    ...
    oxc_react_compiler_optimization::dead_code_elimination(func, env);
    ...
    if let Err(err) = oxc_react_compiler_ssa::rewrite_instruction_kinds_based_on_reassignment(func, env) {
