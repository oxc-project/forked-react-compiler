...
//! `[package] name`, which becomes `forked_react_compiler*`. The tool also writes the
...
# (publishes `forked_react_compiler` + its deps; `publish = false` crates are skipped).
[[releases]]
name = "crates"
root_crate = "forked_react_compiler"
